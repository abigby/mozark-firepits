...
// Product  slider here
const productOne = new Swiper('.product__slider', {
    spaceBetween: 24,
    grabCursor: true,
    slidesPerView: 1,
    breakpoints: {
...
// Product Two  slider here
const productTwo = new Swiper('.product2__slider', {
    spaceBetween: 24,
    grabCursor: true,
    slidesPerView: 1,
    breakpoints: {
    ...
    speed: 500,
    navigation: {
        nextEl: ".product2__slider-next",
        prevEl: ".product2__slider-prev",
    },
});
